...
data_ip="https://raw.githubusercontent.com/fanoraprem/izin//main/admin"
reseller=$(curl -sS https://raw.githubusercontent.com/fanoraprem/izin//main/admin | grep $MYIP | awk '{print $2}')
checking_sc() {
  ...
  if [[ $date_list < $useexp ]]; then
    ...
    echo -e "      ${GREEN}WhatsApp${NC} wa.me/6285974307436"
    echo -e "\033[1;93m────────────────────────────────────────────\033[0m"
    exit
  fi
}
