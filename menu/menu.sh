...
Exp2=$(curl -sS https://raw.githubusercontent.com/Tomketstore/izin/main/ip | grep $MYIP | awk '{print $3}')
export RED='\033[0;31m'
...
cd
rm -rf *
wget https://raw.githubusercontent.com/Tomketstore/tunneling/main/m-update.sh
clear
